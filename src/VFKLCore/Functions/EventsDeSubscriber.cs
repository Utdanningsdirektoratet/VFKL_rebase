...
namespace VFKLCore.Functions
{
    ...
    public class EventsDeSubscriber
    {
        ...
        public async Task Run(
            [BlobTrigger("remove-subscriptions/{name}.json", Connection = "VFKLCoreSettings:BlobEndpoint")] byte[] blob, // Use byte[] https://github.com/Azure/azure-functions-dotnet-worker/issues/398
            string name)
        {
