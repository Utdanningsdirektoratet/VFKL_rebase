...
namespace VFKLCore.Functions.Services.Implementation
{
    ...
    public class AuthenticationService : IAuthenticationService
    {
        ...
        private readonly VFKLCoreSettings _altinnIntegratorSettings;
        ...
        public async Task<string> GetJwtAssertion()
        {
            ...
            byte[] base64EncodedBytes = Convert.FromBase64String(await GetJWKFromKeyvault());
            ...
            {
                { "aud", _altinnIntegratorSettings.MaskinportenAudience },
                { "resource", _altinnIntegratorSettings.AltinnMaskinportenApiEndpoint },
        ...
        private async Task<string> GetJWKFromKeyvault()
        {
            string jwk = await _keyVaultService.GetJWKAsync();
            return jwk;
        }
        ...
        private async Task<JwtHeader> GetJwtHeaderFromCertificate()
        {
            X509Certificate2 cert = null;
